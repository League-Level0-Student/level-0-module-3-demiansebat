...
String yay= JOptionPane.showInputDialog(null, "How many cats do you have?");
		// 2. Convert their answer into an int
int number= Integer.parseInt(yay);
...
if(number<3&&number >0){
	playVideo("https://www.youtube.com/watch?v=g7ZnOq-o7rc");
}
